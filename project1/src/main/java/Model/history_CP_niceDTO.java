...
public class history_CP_niceDTO {
	...
	public history_CP_niceDTO() {
		
	}
	public history_CP_niceDTO(int party_seq, String party_title, String party_type, String party_content, String party_addr,
