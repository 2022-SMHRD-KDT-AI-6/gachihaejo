	...
	for (i = 0; i < $(target).length; i++) {
		(function(z) {
			...
			$(a2).on("change", function() {
				a3.empty().append("<option value=''></option>");
				var Region = a1.val();
				var Do = $(this).val();
		...
		function init(t, first) {
			first ? t.empty().append("<option value=''>지역선택</option>") : "";
			t.next().empty().append("<option value=''>      </option>");
			t.next().next().empty().append("<option value=''>       </option>");
		}
	}
}
function moveMap() {
